...
if(isset($_POST['number'])) {
  $number = $_POST['number'];
  echo convertNumberToWord($number);
}
...
function convertNumberToWord($number) {
  ...
  if($number >= 1000000) {
    $numberString = convertNumberToWord((int)($number/1000000))." million ";
    if(($number%1000000) > 0) {
      $numberString .= "and ".convertNumberToWord($number%1000000);
    }
    return $numberString;
  }
  if($number >= 1000) {
    $numberString = convertNumberToWord((int)($number/1000))." thousand ";
    if(($number%1000) > 0) {
      $numberString .= "and ".convertNumberToWord($number%1000);
    }
    return $numberString;
  }
  if($number >= 100) {
    $numberString = $hundreds[$number/100];
    if(($number%100) > 0) {
      $numberString .= " and ".convertNumberToWord($number%100);
    }
    return $numberString;
  }
  if($number >= 20) {
